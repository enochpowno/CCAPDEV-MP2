...
function createMoviePost(title, poster, synopsis, upvote, downvote, price, status, username1, review, username2, comment, title, date) {
...
function createComment(username, comment, title, date) {
    return new Comment({
        username,
        comment,
        title,
...
findUser()
createMovie("The dark", "jpg", "About a dark mammal", "45", "12", "Php 120.50", "available")
findMovie()
createMoviePost("The dark", "jpg", "About a dark mammal", "45", "12", "Php 120.50", "available", "juantwo35", "Magnificent!", "juantwo35", "I liked it!", "The dark", "January 15")
findMoviePost()
createComment("juantwo35", "I liked it!", "The dark", "January 15")
findComment()
